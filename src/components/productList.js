		...
		<>
			<div class="topbar-wrapper">
	           <div class="account-wrapper">
	              <div class="account-logo-wrapper"><img src="assets/images/thumbnails/Logo.svg" alt="Logo" /></div>
	           </div>
	           <button class="toggle-sidebar"><img src="assets/images/icons/icon-menu.svg" alt="menu" /></button>
	                 ...
	                 <li class="list-items user_peofile">
	                    <div class="media align-items-center dropdown-toggle " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                       ...
	                       <div class="media-body">
	                          ...
	                          <div class="dropdown-menu dropdown-menu-right animate slideIn account_info" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="#"> <i class="flaticon-logout"></i> <Link to="/login">Logout</Link></a></div>
	                       </div>
	                    </div>
	                 </li>
	              </ul>
	                ...
	                <div class="sidebar-content-wrapper">
	                    <ul class="sidebar-list">
	                        <li class="sidebar-list-item has-subnav active" id="listTem">
	                            ...
	                            <ul>
	                                <li>
	                                    <Link to="/list"  class="sidebar-link">Product List</Link>
	                                </li>
	                                <li>
	                                <Link to="/add"  class="sidebar-link">Add Product</Link>
	                                </li>
	                            </ul>
	                        </li>
	                    </ul>
	              ...
	              <div class="content-area-wrapper">
	                 <div class="content-wrapper">
	                    <div class="filter_wrapper  d-block d-sm-none">
	                       <div class="filet_left_content">
	                          <div class="input-group">
	                             <div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><img src="images/icons/magnifying-glass.png" alt="search" /></span></div>
	                             <input type="text" class="form-control input_modify" placeholder="Search" />
	                          </div>
	                       </div>
	                    </div>
	                                   ...
	                                   <tr>
	                                      ...
	                                      <td class="actions">
	                                         <div class="dropdown dropdown_wrapper ">
	                                            ...
	                                            <div class="dropdown-menu dropdown-menu-right  "><a class="dropdown-item" href="editproduct.html">Edit Product</a><button class="dropdown-item">Delete</button></div>
	                                         </div>
	                                      </td>
	                                   </tr>
	                                   <tr>
